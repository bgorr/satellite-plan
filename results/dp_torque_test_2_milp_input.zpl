...
;param Imax := 67 # total number of images
;param Tmax := 49 # simulation time window in seconds
...
param access[TIPS] :=
	read "./dp_torque_test_2_milp_accesses.csv" as "<11n,10n,9n,8n> 12n" skip 1 default 0;

# slewing constraint parameters
param times[T] := 
	read "./dp_torque_test_2_milp_accesses.csv" as "<11n> 5n" skip 1 default 0;

# set reward values
param r[I] := 
	read "./dp_torque_test_2_milp_accesses.csv" as "<10n> 7n" skip 1 default 0;
