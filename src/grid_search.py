...
experiment_num = 0
settings_list = []
agilities = [0.01,0.1,1,5]
event_frequencies = [0.1/3600,0.01/3600,0.001/3600,1e-4/3600]
event_densities = [1,2,5,10]
...
# with open('./grid_search_112623.csv','w') as csvfile:
...
for settings in settings_list:
    ...
    with open('./grid_search_112623.csv','a') as csvfile:
        csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
