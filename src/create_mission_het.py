...
def create_mission_het(settings):
    ...
    r = settings["num_planes"]*settings["experiment_settings"]["num_event_types"]; # number of planes
    s = settings["num_sats_per_plane"]*settings["experiment_settings"]["num_event_types"]; # number of satellites per plane
    altitude = 500
    ecc = 0.0001
    inc = 90
    argper = 0.0
