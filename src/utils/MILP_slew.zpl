...
param Imax := 503; # total number of images
param Tmax := 875; # simulation time window in seconds
...
param access[TIPS] :=
	read "C:\Users\littl\OneDrive - Texas A&M University\SEAK\thesis\milp planner\5 sat sol for 0.1 Nm slew torque\accesses_2h_5sat_processed.csv" as "<11n,10n,9n,8n> 12n" skip 1 default 0;

# slewing constraint parameters
param times[T] := 
	read "C:\Users\littl\OneDrive - Texas A&M University\SEAK\thesis\milp planner\5 sat sol for 0.1 Nm slew torque\accesses_2h_5sat_processed.csv" as "<11n> 5n" skip 1 default 0;

# set reward values
param r[I] := 
	read "C:\Users\littl\OneDrive - Texas A&M University\SEAK\thesis\milp planner\5 sat sol for 0.1 Nm slew torque\accesses_2h_5sat_processed.csv" as "<10n> 7n" skip 1 default 0;
