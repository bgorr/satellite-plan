...
rows = {}
plot_dir = "./plots/lightning_plots/"
if not os.path.exists(plot_dir):
    os.mkdir("./plots/lightning_plots/")

with open("./studies/lightning_constellation_study.csv",newline='') as csv_file:
...
for row_key in rows.keys():
    ...
    plt.savefig(plot_dir+"/lightning_"+row_key+"_linear.png",dpi=300, bbox_inches="tight")
