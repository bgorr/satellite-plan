...
rows = {}
with open("./studies/flood_reobs_study.csv",newline='') as csv_file:
...
plt.savefig(plot_dir+"/flood_reobs_study_fivefov_linear.png",dpi=300, bbox_inches="tight")
