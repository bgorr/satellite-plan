...
event_lons = []
event_durations = []
with open(fire_filepath,'r') as csvfile:
...
plt.scatter(event_lons,event_lats,0.5,marker='o',color='red',transform=data_crs)
...
# bbox = ax.get_tightbbox(None)
# x0,y0,w,h = bbox.bounds
# print(x0)
# print(y0)
# print(w)
# print(h)
# rect = patches.Rectangle((10, -85), 160, 150, linewidth=1, edgecolor='red', facecolor='red',alpha=1)
# ax.add_patch(rect) 
...
ax_sub= inset_axes(ax, width=width, height=width, loc=10, 
                       ...
                       borderpad=0)
ax_sub.hist(event_durations,color='red')
