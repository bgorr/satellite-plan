...
rows = {}
with open("./studies/flood_reobs_study_nofov.csv",newline='') as csv_file:
...
plt.savefig(plot_dir+"/flood_reobs_study_kde.png",dpi=300, bbox_inches="tight")
