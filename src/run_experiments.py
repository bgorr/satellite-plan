...
event_density_levels = [1,5,10,50,20]
...
with open('./experiment_results_two.csv','w') as csvfile:
    ...
    first_row = ["name","for","fov","constellation_size","agility",
                ...
                "init_event_obs_count","init_events_seen","init_events_seen_avg",
                "replan_event_obs_count","replan_events_seen","replan_events_seen_avg",
                "vis_event_obs_count","vis_events_seen","vis_events_seen_avg","time"]
...
for settings in settings_list:
    ...
    with open('./experiment_results.csv','a') as csvfile:
        csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
        row = [settings["name"],settings["ffor"],settings["ffov"],settings["constellation_size"],settings["agility"],
            ...
            settings["planner"],settings["reobserve"],
            overall_results["num_events"],overall_results["num_obs_init"],overall_results["num_obs_replan"],overall_results["num_vis"],
            overall_results["init_results"]["event_obs_count"],overall_results["init_results"]["events_seen_once"],overall_results["init_results"]["events_seen_once_average"],
            overall_results["replan_results"]["event_obs_count"],overall_results["replan_results"]["events_seen_once"],overall_results["replan_results"]["events_seen_once_average"],
            overall_results["vis_results"]["event_obs_count"],overall_results["vis_results"]["events_seen_once"],overall_results["vis_results"]["events_seen_once_average"],
            elapsed_time
        ]
