...
from src.multiagent_rl.mappo_agent_fullstate import Agent
...
if __name__ == '__main__':
    name = "mappo_test_fov_step_fullstate"
    settings = {
        "name": name,
        "instrument": {
            "ffor": 60,
    ...
    learn_iters = 0
    best_score = -1000
    figure_file = 'plots/mappo_fov_step_fullstate.png'
    score_history = []
    ...
    joint_observation_space_size = 5*len(satellites) + len(grid_locations)
