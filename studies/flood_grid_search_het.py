...
if __name__ == "__main__":
    with open('./studies/flood_grid_search_het.csv','w') as csvfile:
    ...
    reobs_options = ["linear_increase","linear_decrease","decaying_decrease","decaying_increase","immediate_decrease","no_change"]
    i = 0
    for reobs_option in reobs_options:
        ...
        with open('./studies/flood_grid_search_het.csv','a') as csvfile:
            csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
