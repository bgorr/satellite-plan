...
if __name__ == "__main__":
    with open('./studies/lightning_parameter_study.csv','w') as csvfile:
    ...
    sharing_horizons = [50,100,500,1000]
    planning_horizons = [500,5000]
    reobserve_conopses = ["linear_increase","linear_decrease","decaying_decrease","decaying_increase","immediate_decrease"]
    ...
    name = "lightning_parameter_study"
    default_settings = {
        "name": name,
        "instrument": {
            "ffor": 60,
    ...
    for parameter in parameters:
        for level in parameters[parameter]:
            experiment_name = 'lightning_parameter_'+str(i)
    ...
    for i in range(len(settings_list)):
        ...
        start = time.time()
        print(settings["name"])
        if settings["name"] != "lightning_parameter_study":
            mission_src = "./missions/lightning_parameter_study/"
        ...
        with open('./studies/lightning_parameter_study.csv','a') as csvfile:
            csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
