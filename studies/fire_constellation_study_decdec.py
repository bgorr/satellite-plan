...
if __name__ == "__main__":
    with open('./studies/fire_constellation_study_decdec.csv','w') as csvfile:
    ...
    for constellation_option in constellation_options:
        ...
        settings = {
            ...
            "rewards": {
                "reward": 10,
                "reward_increment": 1,
                "reobserve_conops": "decaying_decrease",
        ...
        with open('./studies/fire_constellation_study_decdec.csv','a') as csvfile:
            csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
