...
if __name__ == "__main__":
    with open('./studies/flood_reobs_study_nofov.csv','w') as csvfile:
    ...
    for parameter in parameters:
        for level in parameters[parameter]:
            experiment_name = 'flood_reobs_study_nofov_'+str(i)
    ...
    for i in range(len(settings_list)):
        ...
        if settings["name"] != "flood_reobs_study_nofov" and not os.path.exists(mission_dst):
            mission_src = "./missions/flood_reobs_study_nofov/"
            try:
        ...
        with open('./studies/flood_reobs_study_nofov.csv','a') as csvfile:
            csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
