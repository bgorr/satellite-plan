...
from plan_mission import plan_mission_horizon, plan_mission_replan_interval, plan_mission_replan_oracle, plan_mission_replan_interval_het
...
if __name__ == "__main__":
    # with open('./updated_experiment_het.csv','w') as csvfile:
    ...
    #                 "init_event_obs_count","init_events_seen_1+","init_events_seen_1","init_events_seen_2","init_events_seen_3","init_events_seen_4","init_event_reward","init_planner_reward","init_perc_cov","init_max_rev","init_avg_rev","init_all_perc_cov","init_all_max_rev","init_all_avg_rev", "coobs_seen_at_least_once_loose", "coobs_seen_once_loose", "coobs_seen_twice_loose", "coobs_seen_thrice_loose", "coobs_seen_fourplus_loose","coobs_seen_at_least_once_strict", "coobs_seen_once_strict", "coobs_seen_twice_strict", "coobs_seen_thrice_strict","coobs_seen_fourplus_strict",  
    #                 "replan_event_obs_count","replan_events_seen_1+","replan_events_seen_1","replan_events_seen_2","replan_events_seen_3","replan_events_seen_4+","replan_event_reward","replan_planner_reward","replan_perc_cov","replan_max_rev","replan_avg_rev","replan_all_perc_cov","replan_all_max_rev","replan_all_avg_rev","coobs_seen_at_least_once_loose", "coobs_seen_once_loose", "coobs_seen_twice_loose", "coobs_seen_thrice_loose", "coobs_seen_fourplus_loose","coobs_seen_at_least_once_strict", "coobs_seen_once_strict", "coobs_seen_twice_strict", "coobs_seen_thrice_strict","coobs_seen_fourplus_strict",  
    #                 "replan_het_event_obs_count","replan_het_events_seen_1+","replan_het_events_seen_1","replan_het_events_seen_2","replan_het_events_seen_3","replan_het_events_seen_4+","replan_het_event_reward","replan_het_planner_reward","replan_het_perc_cov","replan_het_max_rev","replan_het_avg_rev","replan_het_all_perc_cov","replan_het_all_max_rev","replan_het_all_avg_rev","coobs_seen_at_least_once_loose", "coobs_seen_once_loose", "coobs_seen_twice_loose", "coobs_seen_thrice_loose", "coobs_seen_fourplus_loose","coobs_seen_at_least_once_strict", "coobs_seen_once_strict", "coobs_seen_twice_strict", "coobs_seen_thrice_strict","coobs_seen_fourplus_strict",  
    #                 "oracle_event_obs_count","oracle_events_seen_1+","oracle_events_seen_1","oracle_events_seen_2","oracle_events_seen_3","oracle_events_seen_4+","oracle_event_reward","oracle_planner_reward","oracle_perc_cov","oracle_max_rev","oracle_avg_rev","oracle_all_perc_cov","oracle_all_max_rev","oracle_all_avg_rev","coobs_seen_at_least_once_loose", "coobs_seen_once_loose", "coobs_seen_twice_loose", "coobs_seen_thrice_loose", "coobs_seen_fourplus_loose","coobs_seen_at_least_once_strict", "coobs_seen_once_strict", "coobs_seen_twice_strict", "coobs_seen_thrice_strict","coobs_seen_fourplus_strict",  
    #                 "time"]
    #     csvwriter.writerow(first_row)
    #     csvfile.close()
    if os.path.exists("lhs_49.txt"):
        scaled_sample = np.loadtxt("lhs_49.txt",dtype=float)
    else:
        sampler = qmc.LatinHypercube(d=7, strength=2, optimization="lloyd")

        sample = sampler.random(n=49)
        scaled_sample = qmc.scale(sample,[0,0,0,0,0,0,0],[4,2,3,3,3,2,4])
    ...
    for i in range(start_ind,len(scaled_sample)):
        ...
        num_meas_types_option = num_meas_types_options[int(np.floor(design[4]))]
        ...
        name = "updated_experiment_het_"+str(i)
        settings = {
            "name": name,
            "instrument": {
                "ffor": for_option,
            ...
            "planner": "dp",
            "num_meas_types": num_meas_types_option,
            "sharing_horizon": 500,
        ...
        with open('./updated_experiment_het.csv','a') as csvfile:
            csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
            row = [settings["name"],settings["instrument"]["ffor"],settings["instrument"]["ffov"],settings["constellation"]["num_planes"],settings["constellation"]["num_sats_per_plane"],settings["agility"]["max_slew_rate"],
                ...
                overall_results["init_results"]["event_obs_count"],overall_results["init_results"]["events_seen_at_least_once"],overall_results["init_results"]["events_seen_once"],overall_results["init_results"]["events_seen_twice"],overall_results["init_results"]["events_seen_thrice"],overall_results["init_results"]["events_seen_fourplus"],overall_results["init_results"]["event_reward"],overall_results["init_results"]["planner_reward"],overall_results["init_results"]["percent_coverage"],overall_results["init_results"]["event_max_revisit_time"],overall_results["init_results"]["event_avg_revisit_time"],overall_results["init_results"]["all_percent_coverage"],overall_results["init_results"]["all_max_revisit_time"],overall_results["init_results"]["all_avg_revisit_time"], overall_results["init_results"]["coobs_seen_at_least_once_loose"], overall_results["init_results"]["coobs_seen_once_loose"], overall_results["init_results"]["coobs_seen_twice_loose"], overall_results["init_results"]["coobs_seen_thrice_loose"], overall_results["init_results"]["coobs_seen_fourplus_loose"], overall_results["init_results"]["coobs_seen_at_least_once_strict"], overall_results["init_results"]["coobs_seen_once_strict"], overall_results["init_results"]["coobs_seen_twice_strict"], overall_results["init_results"]["coobs_seen_thrice_strict"], overall_results["init_results"]["coobs_seen_fourplus_strict"],  
                overall_results["replan_results"]["event_obs_count"],overall_results["replan_results"]["events_seen_at_least_once"],overall_results["replan_results"]["events_seen_once"],overall_results["replan_results"]["events_seen_twice"],overall_results["replan_results"]["events_seen_thrice"],overall_results["replan_results"]["events_seen_fourplus"],overall_results["replan_results"]["event_reward"],overall_results["replan_results"]["planner_reward"],overall_results["replan_results"]["percent_coverage"],overall_results["replan_results"]["event_max_revisit_time"],overall_results["replan_results"]["event_avg_revisit_time"],overall_results["replan_results"]["all_percent_coverage"],overall_results["replan_results"]["all_max_revisit_time"],overall_results["replan_results"]["all_avg_revisit_time"], overall_results["replan_results"]["coobs_seen_at_least_once_loose"], overall_results["replan_results"]["coobs_seen_once_loose"], overall_results["replan_results"]["coobs_seen_twice_loose"], overall_results["replan_results"]["coobs_seen_thrice_loose"], overall_results["replan_results"]["coobs_seen_fourplus_loose"], overall_results["replan_results"]["coobs_seen_at_least_once_strict"], overall_results["replan_results"]["coobs_seen_once_strict"], overall_results["replan_results"]["coobs_seen_twice_strict"], overall_results["replan_results"]["coobs_seen_thrice_strict"], overall_results["replan_results"]["coobs_seen_fourplus_strict"],  
                overall_results["replan_het_results"]["event_obs_count"],overall_results["replan_het_results"]["events_seen_at_least_once"],overall_results["replan_het_results"]["events_seen_once"],overall_results["replan_het_results"]["events_seen_twice"],overall_results["replan_het_results"]["events_seen_thrice"],overall_results["replan_het_results"]["events_seen_fourplus"],overall_results["replan_het_results"]["event_reward"],overall_results["replan_het_results"]["planner_reward"],overall_results["replan_het_results"]["percent_coverage"],overall_results["replan_het_results"]["event_max_revisit_time"],overall_results["replan_het_results"]["event_avg_revisit_time"],overall_results["replan_het_results"]["all_percent_coverage"],overall_results["replan_het_results"]["all_max_revisit_time"],overall_results["replan_het_results"]["all_avg_revisit_time"], overall_results["replan_het_results"]["coobs_seen_at_least_once_loose"], overall_results["replan_het_results"]["coobs_seen_once_loose"], overall_results["replan_het_results"]["coobs_seen_twice_loose"], overall_results["replan_het_results"]["coobs_seen_thrice_loose"], overall_results["replan_het_results"]["coobs_seen_fourplus_loose"], overall_results["replan_het_results"]["coobs_seen_at_least_once_strict"], overall_results["replan_het_results"]["coobs_seen_once_strict"], overall_results["replan_het_results"]["coobs_seen_twice_strict"], overall_results["replan_het_results"]["coobs_seen_thrice_strict"], overall_results["replan_het_results"]["coobs_seen_fourplus_strict"],  
                overall_results["oracle_results"]["event_obs_count"],overall_results["oracle_results"]["events_seen_at_least_once"],overall_results["oracle_results"]["events_seen_once"],overall_results["oracle_results"]["events_seen_twice"],overall_results["oracle_results"]["events_seen_thrice"],overall_results["oracle_results"]["events_seen_fourplus"],overall_results["oracle_results"]["event_reward"],overall_results["oracle_results"]["planner_reward"],overall_results["oracle_results"]["percent_coverage"],overall_results["oracle_results"]["event_max_revisit_time"],overall_results["oracle_results"]["event_avg_revisit_time"],overall_results["oracle_results"]["all_percent_coverage"],overall_results["oracle_results"]["all_max_revisit_time"],overall_results["oracle_results"]["all_avg_revisit_time"], overall_results["oracle_results"]["coobs_seen_at_least_once_loose"], overall_results["oracle_results"]["coobs_seen_once_loose"], overall_results["oracle_results"]["coobs_seen_twice_loose"], overall_results["oracle_results"]["coobs_seen_thrice_loose"], overall_results["oracle_results"]["coobs_seen_fourplus_loose"], overall_results["oracle_results"]["coobs_seen_at_least_once_strict"], overall_results["oracle_results"]["coobs_seen_once_strict"], overall_results["oracle_results"]["coobs_seen_twice_strict"], overall_results["oracle_results"]["coobs_seen_thrice_strict"], overall_results["oracle_results"]["coobs_seen_fourplus_strict"],  
                elapsed_time
            ]
