...
if __name__ == "__main__":
    with open('./studies/clustered_reobs_study.csv','w') as csvfile:
    ...
    for parameter in parameters:
        for level in parameters[parameter]:
            experiment_name = 'clustered_reobs_study_'+str(i)
    ...
    for i in range(len(settings_list)):
        ...
        if settings["name"] != "clustered_reobs_study" and not os.path.exists(mission_dst):
            mission_src = "./missions/clustered_reobs_study/"
            try:
        ...
        with open('./studies/clustered_reobs_study.csv','a') as csvfile:
            csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
