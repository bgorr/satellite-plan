...
if __name__ == "__main__":
    with open('./studies/flood_parameter_study.csv','w') as csvfile:
    ...
    reobserve_conopses = ["linear_increase"]
    ...
    for parameter in parameters:
        for level in parameters[parameter]:
            experiment_name = 'flood_reobservation_plot_'+str(i)
    ...
    for i in range(len(settings_list)):
        ...
        with open('./studies/flood_reobservation_study_plot.csv','a') as csvfile:
            csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
