...
from src.plan_mission import plan_mission_horizon, plan_mission_replan_interval, plan_mission_replan_oracle
...
if __name__ == "__main__":
    with open('./studies/flood_reobs_study_onefov.csv','w') as csvfile:
    ...
    for parameter in parameters:
        for level in parameters[parameter]:
            experiment_name = 'flood_reobs_study_onefov_'+str(i)
    ...
    for i in range(len(settings_list)):
        ...
        if settings["name"] != "flood_reobs_study_onefov" and not os.path.exists(mission_dst):
            mission_src = "./missions/flood_reobs_study_onefov/"
            try:
        ...
        with open('./studies/flood_reobs_study_onefov.csv','a') as csvfile:
            csvwriter = csv.writer(csvfile,delimiter=',',quotechar='|')
